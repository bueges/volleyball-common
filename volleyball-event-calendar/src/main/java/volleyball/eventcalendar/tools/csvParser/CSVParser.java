...
public class CSVParser {
    ...
    public List<ParserResult> parseFile() {
        List<ParserResult> parserResultList = Lists.newArrayList();
     ...
     */
    private String getCSVFieldValue(String[] csvFields, int fieldIndex) {
